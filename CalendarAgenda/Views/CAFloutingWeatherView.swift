...
class CAFloutingWeatherView: UIView, CAWeatherDataUpdatable {
    ...
    convenience init(weatherManager: CAWeatherDataControllable, weatherDate: Date) {
        self.init(frame:CGRect(x: 0, y: 0, width: Constants.floutingViewRadius, height: Constants.floutingViewRadius))
...
extension CAFloutingWeatherView {
    struct Constants {
        static let floutingViewRadius: CGFloat = 50
